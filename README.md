...
Engineers Using Arduino course at Ghana Communication Technology University (GCTU).
...
## How to run it
1. Wire the buzzer to pin 10 (note: pin 8 was already used by a
   segment wire on my board, so I moved the buzzer to pin 10 to
   avoid a pin conflict — update the code's buzzerPin variable to
   match whichever pin you actually use).
...
## Author
Philemon Opoku-Prempeh (GENIX) - [2526400519]
